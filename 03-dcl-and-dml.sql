...
-- 로그인 권한 부여
CREATE USER C##NAMSK IDENTIFIED BY 1234;   -- 로그인할 수 없는 상태
-- 절절한 권한을 부여해야 한다ㅏ
...
SHOW USER;
-- System 계정으로 진행
-- HR 계정의 employees 테이블의 조회 권한을 C##NAMSK에게 부여하고 싶다면(system)
GRANT SELECT ON hr.employees TO C##NAMSK;   --  권한의 부여
REVOKE SELECT ON hr.employees FROM C##NAMSK;    -- 권한의 회수
